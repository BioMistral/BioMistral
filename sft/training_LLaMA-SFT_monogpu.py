...
from transformers import AutoModelForCausalLM, set_seed, AutoTokenizer, BitsAndBytesConfig, LlamaTokenizer, LlamaForCausalLM
...
def main():
    ...
    # TOKENIZER
    ###########
    tokenizer = LlamaTokenizer.from_pretrained(args.model_name, model_max_length=2048, padding=True)
    ...
    model = LlamaForCausalLM.from_pretrained(args.model_name, **model_kwargs)
